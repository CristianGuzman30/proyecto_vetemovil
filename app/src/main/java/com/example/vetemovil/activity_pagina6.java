...
public class activity_pagina6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentInicio = new iniciofragment(); // Reemplaza "TuFragmentInicio" con el nombre de tu fragmento de inicio
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.mr_firulays:
                transaction.replace(R.id.contenedorFragments, fragmentmrfirulays);
                transaction.addToBackStack(null);
                break;

            case R.id.animalandia:
                transaction.replace(R.id.contenedorFragments, fragmentanimalandia);
                transaction.addToBackStack(null);
                break;

            case R.id.animalitos:
                transaction.replace(R.id.contenedorFragments, fragmentanimalitos);
                transaction.addToBackStack(null);
                break;
        }
        transaction.commit();
